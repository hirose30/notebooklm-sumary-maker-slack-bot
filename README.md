...
- 🎨 **インフォグラフィック**: AI生成の視覚的サマリーを自動添付
- 🛡️ **部分成功対応**: 一部の生成物が失敗しても成功したものを投稿
...
4. スレッドに結果が投稿される！
   ...
   インフォグラフィックも自動的に添付されます（生成された場合）。

   一部の生成でエラーが発生した場合も、成功したものは投稿されます：
   ```
   ✅ 処理が完了しました！
...
- ✅ **インフォグラフィック生成**: AI が作成した視覚的サマリーを Slack に自動添付
- ✅ **部分成功対応**: 音声・動画・インフォグラフィックを個別にエラーハンドリング、1つでも成功すれば結果を投稿
